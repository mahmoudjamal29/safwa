...
}>({ indicator: null, indicatorPosition: 'left', indicatorVisibility: true })
...
const Select = ({
  ...
  return (
    <SelectContext.Provider
      value={{ indicator, indicatorPosition, indicatorVisibility }}
    >
  ...
  `,
  {
    ...
    variants: {
      size: {
        ...
        md: 'h-8.5 px-3 text-sm leading-(--text-sm--line-height) gap-1 rounded-md',
...
function SelectItem({
  ...
  const { indicator, indicatorPosition, indicatorVisibility } =
